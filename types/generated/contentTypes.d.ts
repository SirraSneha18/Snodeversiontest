...
export interface ApiBookingBooking extends Schema.CollectionType {
  ...
  attributes: {
    BookingId: Attribute.String & Attribute.Required & Attribute.Unique;
    ...
    CancellationReason: Attribute.String;
    Status: Attribute.Enumeration<
      ['PENDING', 'CONFIRMED', 'CANCELLED', 'CONSUMED', 'UNCONSUMED']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'PENDING'>;
    booking_campaign: Attribute.Relation<
      'api::booking.booking',
      'manyToOne',
      'api::booking-campaign.booking-campaign'
    >;
    table_type: Attribute.Relation<
      'api::booking.booking',
      'manyToOne',
...
export interface ApiBookingCampaignBookingCampaign
  extends Schema.CollectionType {
  ...
  attributes: {
    BookingDate: Attribute.Date & Attribute.Required;
    Status: Attribute.Enumeration<['OPENED', 'CLOSED', 'COMPLETED']> &
      Attribute.Required &
      Attribute.DefaultTo<'OPENED'>;
...
export interface ApiPicturePicture extends Schema.CollectionType {
  ...
  attributes: {
    ...
    picture_set: Attribute.Relation<
      'api::picture.picture',
      'manyToOne',
      'api::picture-set.picture-set'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPictureSetPictureSet extends Schema.CollectionType {
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    events: Attribute.Relation<
      ...
      'api::event.event'
    >;
    booking_campaigns: Attribute.Relation<
      'api::service.service',
      'oneToMany',
      'api::booking-campaign.booking-campaign'
    >;
...
export interface ApiSpotSpot extends Schema.CollectionType {
  ...
  attributes: {
    Title: Attribute.String & Attribute.Required & Attribute.Unique;
    Slug: Attribute.UID<'api::spot.spot', 'Title'> & Attribute.Required;
    Date: Attribute.Date & Attribute.Required;
    IsVideo: Attribute.Boolean;
    YoutubeVideoId: Attribute.String;
    Description: Attribute.Text &
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::spot.spot', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::spot.spot', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiTableTypeTableType extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String & Attribute.Required & Attribute.Unique;
    NumberOfPlaces: Attribute.Integer & Attribute.Required;
    bookings: Attribute.Relation<
      'api::table-type.table-type',
      'oneToMany',
      'api::booking.booking'
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::booking-campaign.booking-campaign': ApiBookingCampaignBookingCampaign;
      'api::event.event': ApiEventEvent;
      'api::picture.picture': ApiPicturePicture;
      'api::picture-set.picture-set': ApiPictureSetPictureSet;
